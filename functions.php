...
function onepress_scripts()
{
	...
	wp_enqueue_style('tailwind-output', get_template_directory_uri() . '/src/output.css', array(), $version);
	wp_enqueue_style('tw-element-css', 'https://cdn.jsdelivr.net/npm/tw-elements/dist/css/tw-elements.min.css', array(), $version);
	...
	//wp_enqueue_script('tw-elements-js', get_template_directory_uri() . '/node_modules/tw-elements/js/tw-elements.umd.min.js',  $version, true);
	wp_enqueue_script('tw-elements-cdn-js', 'https://cdn.tailwindcss.com/3.3.0',  $version, false);
	wp_enqueue_script('tw-elements-js', 'https://cdn.jsdelivr.net/npm/tw-elements/dist/js/tw-elements.umd.min.js',  $version, false);
...
function woo_cart_but() {
	ob_start();
        ...
        ?>
        <div><a class="menu-item cart-contents relative" href="<?php echo $cart_url; ?>" title="My Basket">
	    <?php
        //if ( $cart_count > 0 ) {
       ?>
        ...
        //}
        ?>
        </a><span class="text-white"><?php echo $cart_total; ?></span><span class="mx-2 text-white">|</span></div>
...
function woo_cart_but_count( $fragments ) {
    ...
    ?>
    <a class="cart-contents menu-item relative" href="<?php echo $cart_url; ?>" title="<?php _e( 'View your shopping cart' ); ?>">
	<?php
    //if ( $cart_count > 0 ) {
        ?>
        <span class="cart-contents-count"><?php echo $cart_count; ?></span>
        <?php            
    //}
        ?></a><span class="text-white"><?php echo $cart_total; ?></span><span class="mx-2 text-white">|</span>
    <?php
